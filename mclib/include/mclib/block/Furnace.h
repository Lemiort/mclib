...
public:
    ...
    int16_t GetBurnTime() const noexcept { return m_BurnTime; }
    ...
    // BurnTime reaches 0.
    int16_t GetCookTime() const noexcept { return m_CookTime; }
    // Number of ticks It takes for the item to be smelted.
    int16_t GetCookTimeTotal() const noexcept { return m_CookTimeTotal; }
};
