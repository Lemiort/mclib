...
class Protocol_1_14_3 : public Protocol {  // TODO check protocol
public:
    Protocol_1_14_3(Version version, StateMap inbound)
        : Protocol(version, inbound) {}
    ...
    virtual s32 GetPacketId(packets::out::PrepareCraftingGridPacket) override {
        throw UnsupportedPacketException(
            "PrepareCraftingGridPacket does not work with protocol 1.14.3");
...
Protocol::StateMap inboundMap_1_14_3 = {  // Check Map
    {State::Login,
     {
         {0x00, protocol::login::Disconnect},
         {0x01, protocol::login::EncryptionRequest},
...
const std::unordered_map<Version, std::shared_ptr<Protocol>> protocolMap = {
    ...
    {Version::Minecraft_1_13_2,
     std::make_shared<Protocol_1_13_2>(Version::Minecraft_1_13_2,
                                       inboundMap_1_13_2)},
    {Version::Minecraft_1_14_3,
     std::make_shared<Protocol_1_14_3>(Version::Minecraft_1_14_3,
                                       inboundMap_1_14_3)},
};
